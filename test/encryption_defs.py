...
def encrypt_text_aes_gcm(plaintext: str, key: bytes) -> str:
    """
    ...
    #iv = os.urandom(12)  # GCM nonce/IV (12 bytes recommended)
    iv = b'=\x02\xc7\xe5\xe4y\x1e^\xa5\xafS\x7f'
    aesgcm = AESGCM(key)

    aad = b"text-v1"  # optional associated data (binds context); must match on decrypt
...
def decrypt_text_aes_gcm(token: str, key: bytes) -> str:
    """
